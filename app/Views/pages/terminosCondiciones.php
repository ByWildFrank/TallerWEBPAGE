  ...
  <div class="container">
    ...
    <div class="masonry">
      ...
      <div class="card">
        ...
        <p>BEAN provee sus servicios "tal cual" y no garantiza continuidad ininterrumpida. <strong>No será responsable</strong> de daños indirectos, lucro cesante o pérdida de datos derivados del uso de la Plataforma o de la compra de productos.</p>
      </div>
      ...
      <div class="card">
        ...
        <p>BEAN podrá actualizar estos Términos en cualquier momento. Las modificaciones se publicarán con nueva fecha de actualización. El uso continuado de la Plataforma implica la <strong>aceptación de los cambios</strong>.</p>
      </div>
