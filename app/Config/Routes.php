...
$routes->get('admin/productos/editar/(:num)', 'AdminController::editarProducto/$1', ['filter' => 'auth:admin']);
$routes->post('admin/productos/actualizar/(:num)', 'AdminController::actualizarProducto/$1', ['filter' => 'auth:admin']);
